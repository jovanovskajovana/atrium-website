...
export const FULL_I = 'M353.221 2.2507H343.022V92.8439H353.221V2.2507Z'
export const FULL_U =
...
export const CHEVRON_A =
  'M52.2308 2.2507H42.7443L1.84082 92.8439H12.2232L47.3587 14.0699L82.2365 92.8439H93.1342L52.2308 2.2507Z'
export const CROSSBAR_T = 'M107.321 2.2507H178.488V11.6962H107.321V2.2507Z'

export const CENTERS_X = [47.5, 142.9, 260.3, 348.1, 441.8, 568.3]
...
export const COLLAGE_IMAGES = [
  {
    ...
    w: 1919,
    h: 2560,
    className: 'top-[2%] left-[72%] w-[18vw]',
  },
  {
  ...
  },
  {
    ...
    w: 750,
    h: 833,
    className: 'top-[22%] left-[58%] w-[13vw]',
  },
  {
    src: '/assets/img-5.webp',
    w: 1919,
    h: 2560,
    className: 'top-[52%] left-[48%] w-[16vw]',
  },
  {
    src: '/assets/img-6.webp',
    w: 1919,
    h: 2560,
    className: 'top-[5%] left-[33%] w-[14vw]',
  },
  {
    src: '/assets/img-7.webp',
    w: 1919,
    h: 2559,
    className: 'top-[60%] left-[28%] w-[15vw]',
  },
  {
    src: '/assets/img-8.webp',
    w: 1920,
    h: 1194,
    className: 'top-[75%] left-[50%] w-[20vw]',
  },
  {
    src: '/assets/img-9.webp',
    w: 1920,
    h: 1194,
    className: 'top-[64%] left-[68%] w-[24vw]',
  },
]
